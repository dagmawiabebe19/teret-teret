...
> = {
  am: {
    ...
    pricingFreeTitle: "ነፃ",
    pricingFreeFeatures: ["በቀን 3 ታሪኮች", "ሶስት ቋንቋዎች", "ከ3 በላይ ማስቀመጥ የለም"],
  ...
  en: {
    ...
    pricingFreeFeatures: ["3 stories per day", "All 3 languages", "No saving beyond 3 stories"],
  ...
  es: {
    ...
    pricingFreeFeatures: ["3 cuentos al día", "Los 3 idiomas", "Sin guardar más de 3 cuentos"],
    pricingPremiumTitle: "Premium",
