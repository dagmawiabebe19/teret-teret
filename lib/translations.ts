...
> = {
  ...
  en: {
    ...
    pricingPremiumFeatures: ["Unlimited stories per day", "Up to 4 child profiles", "Premium AI narration", "Language learning tools"],
  ...
  es: {
    ...
    pricingPremiumTitle: "Premium",
    pricingPremiumFeatures: ["Cuentos ilimitados al día", "Hasta 4 perfiles de niños", "Narración premium con IA", "Herramientas de aprendizaje"],
