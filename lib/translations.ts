...
> = {
  am: {
    ...
    noneYet: "ገና የለም",
    heroHeadline: "ልጅዎ በእያንዳንዱ ታሪክ ጀግና ይሆናሉ",
    ...
    pricingFreeTitle: "ነፃ",
    pricingFreeFeatures: ["በቀን 1 ታሪክ", "ሶስት ቋንቋዎች", "ማስቀመጥ የለም"],
    pricingPremiumTitle: "ፕሪሚየም",
    pricingPremiumFeatures: ["ያልተገደበ ታሪኮች", "ሶስት ቋንቋዎች", "ቤተ-ታሪኮች አስቀምጥ", "የልጅ መገለጫዎች"],
  ...
  en: {
    ...
    noneYet: "None yet",
    heroHeadline: "Your child becomes the hero of every story",
    ...
    testimonial1Quote: "Kasa asks for Teret Stories every night now 🥹",
    ...
    pricingFreeFeatures: ["1 story per day", "All 3 languages", "No saving"],
    pricingPremiumTitle: "Premium",
    pricingPremiumFeatures: ["Unlimited stories", "All 3 languages", "Save library", "Child profiles"],
  ...
  es: {
    ...
    noneYet: "Ninguno aún",
    heroHeadline: "Tu hijo se convierte en el héroe de cada cuento",
    ...
    testimonial1Quote: "Kasa pide Teret Stories cada noche 🥹",
    testimonial1Author: "Mekdes, LA",
    ...
    pricingFreeFeatures: ["1 cuento al día", "Los 3 idiomas", "Sin guardar"],
    pricingPremiumTitle: "Premium",
    pricingPremiumFeatures: ["Cuentos ilimitados", "Los 3 idiomas", "Guardar biblioteca", "Perfiles de niños"],
