...
> = {
  am: {
    ...
    noneYet: "ገና የለም",
    heroHeadline: "ቋንቋ፣ ባህል እና ታሪክ የሚያስተምሩ የግል የመጽለፊያ ታሪኮች",
  ...
  en: {
    ...
    noneYet: "None yet",
    heroHeadline: "Personalized bedtime stories that teach language, culture, and history.",
  ...
  es: {
    ...
    noneYet: "Ninguno aún",
    heroHeadline: "Cuentos personalizados para dormir que enseñan idioma, cultura e historia.",
