...
> = {
  am: {
    ...
    problemHeadline: "ልጅዎ በእንግሊዝኛ ይመልሳል። አማርኛ እንዲረዳ ትፈልጋሉ።",
    problemBody: "በዲያስፖራ የሚኖሩ ወላጆች ይህን ስሜት ያውቃሉ። በአማርኛ ትናገራላችሁ፤ በእንግሊዝኛ ይመልሳሉ። ቋንቋው እየተራቀቀ ነው — ከእርሱ ጋር ባህሉም። ተረት ተረት አንድ ታሪክ በአንድ ሌሊት ለመመለስ ተገኝቷል።",
    howItWorksHeadline: "እንዴት እንደሚሰራ",
    howItWorksSteps: [
      { title: "የልጅዎን ስም እና ዕድሜ ያስገቡ", sub: "30 ሰከንድ" },
      { title: "የኢትዮጵያ ቦታ ይምረጡ", sub: "ላሊበላ፣ አክሱም፣ ስሜን ተራሮች እና ሌሎች" },
    ...
    faqItems: [
      ...
      { q: "ልጄ እንግሊዝኛ ብቻ ከሚናገርስ?", a: "ታሪኮች በእንግሊዝኛም ይወጣሉ። ብዙ ወላጆች በእንግሊዝኛ ይጀምራሉ፤ ልጁ ሲጠቅም አማርኛ ቃላትን ይጨምራሉ።" },
      { q: "በማንኛውም ጊዜ መሰረዝ እችላለሁ?", a: "አዎ — ከመለያ ገጽዎ በአንድ ጠቅታ፣ ታናሽ መጠይቄ የለም።" },
      { q: "ለልጆች ደህንነት አለው?", a: "እያንዳንዱ ታሪክ ለዕድሜ ተገቢ ነው። ማስታወቂያ የለም፣ መከታተል የለም፣ ውይይት የለም።" },
      { q: "ታሪኮቹ ምን ያህል ረጅም ናቸው?", a: "4-6 ገጾች፣ ከ5 ደቂቃ የማንበብ ጊዜ። ለመጽለፊያ ጊዜ ተስማሚ።" },
    ],
    finalCtaHeadline: "ዛሬ ሌሊት ቋንቋውን ለመጣል አንድ እርምጃ ቀርቷል። ወይም ለመጠበቅ።",
    finalCtaButton: "🎁 የመጀመሪያዎን ታሪክ ነፃ ይፍጠሩ →",
    pricingFreeCardTitle: "ዛሬ ይሞክሩ",
    pricingPremiumRibbon: "አብዛኛው ወላጆች ይመርጣሉ",
    pricingNoCard: "ነፃ ይጀምሩ — ካርድ አያስፈልግም",
    landingGenerateButton: "🎁 ታሪክ ፍጠር",
    ...
    customizeStoryToggle: "ታሪክዎን ያብጁ",
    socialProofHeading: "በዓለም ዙሪያ በኢትዮጵያ ቤተሰቦች የተወደደ",
    testimonial1Quote: "6 ዓመቷ ካሳ አሁን በየሌሊቱ «ተረት» ትለኛለች። ከታሪክ «ሰላም አያቴ» ተማራች እና በፌስታይም ለአያቴዬ ተናገረች። እናቴ አለቀች።",
    testimonial1Author: "መቅዱስ ብ., የ2 ልጆች እናት፣ ሎስ አንጀለስ",
    testimonial2Quote: "ዱዮሊንጎ፣ መጽሐፍት፣ ክፍል ሞክረናል። ምንም አልያዘም። ስሙ በአማርኛ ታሪክ ሲሰማ «እኔ ነኝ!» አለ። ይዞ ነው።",
    testimonial2Author: "ዳዊት ከ.፣ የ3 ልጆች አባት፣ ለንደን",
    testimonial3Quote: "ልጆቼ ከኢትዮጵያ ጋር አይገናኙም ብዬ ፈርቻለሁ። ባለፈው ሳምንት ልጅቴ «ንግሥት ታይቱ ማን ናት?» ብላ ጠየቀች — ከተረት ተረት ታሪክ። ይህ ነበር የምፈልገው።",
    testimonial3Author: "ሳራ ሄ.፣ የ1 ልጅ እናት፣ ዋሺንግተን ዲሲ",
    pricingHeading: "ዛሬ ሌሊት ነፃ ይጀምሩ",
    pricingFreeTitle: "ነፃ",
  ...
  en: {
    ...
    ctaCreateFree: "🎁 Generate your first story free",
    ...
    faqItems: [
      ...
      { q: "What if my child only speaks English?", a: "Stories generate in English too. Many parents use English first, then add Amharic words as the child gets curious." },
  ...
  es: {
    ...
    ctaCreateFree: "🎁 Genera tu primer cuento gratis",
    ...
    faqItems: [
      ...
      { q: "¿Y si mi hijo solo habla inglés?", a: "Los cuentos también se generan en inglés. Muchos padres empiezan en inglés y añaden palabras en amárico cuando el niño muestra curiosidad." },
